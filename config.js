...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Diseka Solar Power Solutions",
    phone:     "+27 71 914 4939",
    whatsapp:  "+27 71 914 4939",
    address:   "17 Sol St, Johannesburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Diseka Solar Power Solutions — Solar installation in johannesburg",
    description: "Diseka Solar Power Solutions provides professional solar installation in Johannesburg. 1 Google review. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "Diseka Solar Power Solutions designs and installs solar panel systems, battery backup and inverter solutions for homes and businesses across Johannesburg. Load-shedding proof your property.",
    ...
    band: {
      ...
      alt:   "Diseka Solar Power Solutions team at work in Johannesburg",
